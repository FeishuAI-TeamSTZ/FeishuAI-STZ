...
from benchmark.fixtures.tc001_anti_interference import (
...
from benchmark.fixtures.tc002_contradiction import (
...
print("=" * 60)
print(
    f'TC001: 噪声目标{TC001_CONFIG["total_noise_count"]}条，模拟{TC001_CONFIG["simulation_days"]}天'
)
print(f'TC001: 通过阈值{TC001_CONFIG["pass_threshold"] * 100}%')  # type: ignore[operator]
print(
    f'TC002: 迭代{TC002_CONFIG["iteration_count"]}次，通过阈值{TC002_CONFIG["pass_threshold"] * 100}%'
