...
| **当前 fixture 状态** | v0.1（NPU-src 实现，100 噪声）→ **T-005 需扩展到 1000 噪声**以达项目核心协议 |
...
| **项目映射** | 02-DESIGN §四 机制一 全源跨系统一致性检测的端到端验证 |
...
差距：当前 fixture 基线已建（TC001/TC002 v0.1），但远低于项目级目标。**T-005 拓展为 P0 任务**。
