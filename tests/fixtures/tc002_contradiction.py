...
BOUNDARY_CASES = [
    {
        ...
        "setup": [
            {"id": "dec_bc1_v1", "content": "周报每周五发给李四", "source": "飞书群聊", "source_type": "USER_STATED"},
            {"id": "dec_bc1_v2", "content": "周报每周五发给王五", "source": "飞书文档", "source_type": "DOC_SYNCED"}
        ],
    ...
    },
    {
        ...
        "setup": [
            {"id": "dec_bc2_v1", "content": "周报发给李四", "logical_time": "2026-04-17 10:00:00", "receive_time": "2026-04-20 09:00:00"},
            {"id": "dec_bc2_v2", "content": "周报发给王五", "logical_time": "2026-04-15 10:00:00", "receive_time": "2026-04-20 10:00:00"}
        ],
    ...
    },
    {
        ...
        "setup": [
            ...
            {"id": "dec_bc4_v2", "content": "周报改发给李四", "evolution": "SUPERSEDES", "parent": "dec_bc4_v1"},
            {"id": "dec_bc4_v3", "content": "周报改发给王五", "evolution": "SUPERSEDES", "parent": "dec_bc4_v2"}
        ],
